...
_GtelSoft (Trung tâm phần mềm)_<br>
  - Manual Tester
    + Chuyên viên kiểm thử phần mềm, hỗ trợ test các bug có trên các dự án web app do trung tâm sản xuất theo yêu cầu của Bộ Công an. Hỗ trợ viết testcase, checklist, chạy testcase cả mới và có sẵn.
